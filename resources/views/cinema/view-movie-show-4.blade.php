                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  @foreach($arr as $movie)
                   <tr>
                    ...
                    <td><a href="/cinema/edit-movie-show-4/{{$movie->show_id}}" class="btn btn-primary">Edit</a></td>
                    <td><a href="/cinema/view-movie-show-4/{{$movie->show_id}}" class="btn btn-primary">Delete</button></td>
                  </tr>
                  @endforeach
