...
<body class=" text-dark raleway-medium-font" id="wrapper">
	<div class="container bg-grey m-w-400 p-t-10 p-b-30 p-l-30 b-r-8 m-t-30">
		<div class="middle">
			<img src="{{asset('images/favicon.png')}}" class="m-w-80 b-r-100 bg">
			<h3 class="gilmer-font p-b-10">Your Ticket</h3>
		</div>
		<div class="row input-group">
			@foreach($arr as $detail)
				<div class="mb-3 ">					
					<div type="text" class="image_size_control" readonly required value="{{$detail->name}}"><img src="{{asset('site_images/'.$detail->movie_image)}}"> </div>
				</div>
				<div class="mb-3" style="">					
					<div type="text" class="barcode_size_control" readonly required value="{{$detail->name}}"><img src="{{asset('site_images/barcode.jpg')}}"> </div>
				</div>
				<div class="mb-3 ">					
			...
			<div class="back_to_home">
				<a href="/my_booking">Back to My Bookings</a>
			</div>
		</div>
	</div>
	<footer class="footer">
